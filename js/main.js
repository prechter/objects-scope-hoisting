...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) will produce "I'm a local variable" while console.log(y) will say "global"
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) = undefined, y will produce error message because it hasn't been stated yet, however console.log(foo()) will return "function hoisting" because it's hoisted in its entirety
**************************************************************************************/
...
(function(){
  "use strict";
  var dateInt = Date.UTC(1983, 3, 22);
  var birthday = dateInt;
